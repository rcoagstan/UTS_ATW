...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets_admin/modules/select2/dist/css/select2.full.min.css')}}">
</head>
...
<body>
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <img alt="image" src="{{ asset('assets_admin/img/avatar/avatar-1.png')}}" class="rounded-circle mr-1">
            <div class="d-sm-none d-lg-inline-block">Hi, Agustian</div></a>
  ...
  <script src="{{ asset('assets_admin/modules/select2/dist/js/select2.full.min.js')}}"></script>
  <!-- JS Libraies -->
